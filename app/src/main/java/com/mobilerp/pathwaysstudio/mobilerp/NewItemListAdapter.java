...
public class NewItemListAdapter extends ArrayAdapter<NewItemListModel> {

    private final Context contx;
    private final ArrayList<NewItemListModel> modelsArrayList;

    public NewItemListAdapter(Context context, ArrayList<NewItemListModel> modelsArrayList) {
